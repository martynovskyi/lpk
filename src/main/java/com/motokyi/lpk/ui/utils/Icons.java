...
public class Icons {
    ...
    public static final ImageIcon PLUS_ICON = UIUtils.scaleImageIcon(
            new ImageIcon(Icons.class.getResource("/icons/2x/round_add_black_48dp.png")).getImage(),
            CHEVRON_ICON_EDGE, CHEVRON_ICON_EDGE);

    public static final ImageIcon MORE_CHEVRON = UIUtils.scaleImageIcon(
            new ImageIcon(Icons.class.getResource("/icons/2x/round_expand_more_black_48dp.png")).getImage(),
            CHEVRON_ICON_EDGE, CHEVRON_ICON_EDGE);

    public static final ImageIcon LESS_CHEVRON = UIUtils.scaleImageIcon(
            new ImageIcon(Icons.class.getResource("/icons/2x/round_expand_less_black_48dp.png")).getImage(),
            CHEVRON_ICON_EDGE, CHEVRON_ICON_EDGE);
}
